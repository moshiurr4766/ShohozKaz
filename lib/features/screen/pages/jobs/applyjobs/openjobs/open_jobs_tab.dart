...
//   // Merge both applicant and poster jobs into one stream
...
//       String docId, String newProgress, BuildContext context) async {
//     try {
...
//   Future<void> _markCompleted(Map<String, dynamic> data, String docId) async {
//     try {
//       final completedData = {
//         ...data,
//         'status': 'completed',
...
//       };
//       await FirebaseFirestore.instance.collection('completedJobs').add(completedData);
...
//     return StreamBuilder<QuerySnapshotMock>(
...
//                               onPressed: () => _markCompleted(data, docId),
//                               style: ElevatedButton.styleFrom(
...
//                         child: ElevatedButton(
//                           onPressed: () {
//                             _showSnack(context, "Redirecting to payment...", true);
//                           },
//                           style: ElevatedButton.styleFrom(
//                             backgroundColor: AppColors.button,
//                             shape: RoundedRectangleBorder(
...
// // simple class for combined snapshots
...
// //All Corrent Code Below With logical changes 
...
//             style: ElevatedButton.styleFrom(
//                 backgroundColor: AppColors.button, foregroundColor: Colors.white),
...
//     if (confirm == true) {
//       await _markCompleted(data, docId);
...
//       // Update status for real-time sync
//       await FirebaseFirestore.instance
//           .collection('openJobs')
//           .doc(docId)
//           .update({'status': 'waiting_payment'});

//       // Optionally copy to completedJobs collection
//       await FirebaseFirestore.instance.collection('completedJobs').add(updatedData);
//     } catch (e) {
//       debugPrint('Error completing job: $e');
//     }
//   }
...
//         ...data,
//         'status': 'canceled',
//         'cancelReason': cancelReason, // specific variable for reason
//         'jobOrderId': data['jobOrderId'] ?? docId, // ensure order id saved
//         'posterId': data['posterId'], // ensure poster ref kept
