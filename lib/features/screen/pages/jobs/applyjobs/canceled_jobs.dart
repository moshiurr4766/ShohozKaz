...
//           return Center(child: Text("Error loading canceled jobs or permission denied.",
...
//         if (jobs.isEmpty) return const Center(child: Text("No canceled jobs."));
...
//   // Report canceled job (only once per user per job)
